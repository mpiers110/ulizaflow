<?php
/**
 * Copyright (C) 2023 PM Web Solutions
 *
...
namespace UlizaFLOW\DbConnectAPI;
...
class DataSource
{
    ...
    {
        $thisn = new \mysqli($this->host, $this->username, $this->password, $this->database);

        if (mysqli_connect_errno()) {
            trigger_error("Problem with connecting to database.");
        }

        $thisn->set_charset("utf8");
        return $thisn;
    }
